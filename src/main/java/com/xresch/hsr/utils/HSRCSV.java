...
public class HSRCSV {
	...
	private static Logger logger = (Logger) LoggerFactory.getLogger(HSRCSV.class.getName());
	...
	public static JsonArray toJsonArray(
		...
		if(makeFieldsLowercase) {
			headerArray = HSR.Text.arrayToLowercase(headerArray);
		}
					...
					if(valueString != null) {
						...
						&& (  valueString.startsWith("{")
						   || valueString.startsWith("[") 
							...
							try {
								value = HSR.JSON.fromJson(valueString);
							}catch(Throwable e) {
								HSR.addWarnMessage("JSON from CSV: error while parsing: "+e.getMessage());
